...
import 'package:g4mediamobile/src/screens/mumu_github.dart';
  ...
  Widget build(BuildContext context) {
    return new StoreConnector<G4Store, GithubSearchScreenViewModel>(
      ...
      builder: (BuildContext context, GithubSearchScreenViewModel vm) {
        return new Scaffold(
          appBar: AppBar(
            // Here we take the value from the SettingsScreen object that was created by
